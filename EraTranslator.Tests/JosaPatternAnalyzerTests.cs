...
public sealed class JosaPatternAnalyzerTests
{
    ...
    [Theory]
    [InlineData("%CALLNAME:MASTER%(은)는", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    [InlineData("%CALLNAME:MASTER%은(는)", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    [InlineData("%CALLNAME:MASTER%는(은)", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    [InlineData("%CALLNAME:MASTER%(는)은", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    [InlineData("%CALLNAME:MASTER%은/는", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    [InlineData("%CALLNAME:TARGET%(이)가", "%조사처리(CALLNAME:TARGET,\"이\")%")]
    [InlineData("%CALLNAME:TARGET%이(가)", "%조사처리(CALLNAME:TARGET,\"이\")%")]
    [InlineData("%CALLNAME:TARGET%가(이)", "%조사처리(CALLNAME:TARGET,\"이\")%")]
    [InlineData("%CALLNAME:TARGET%(가)이", "%조사처리(CALLNAME:TARGET,\"이\")%")]
    [InlineData("%CALLNAME:TARGET%이/가", "%조사처리(CALLNAME:TARGET,\"이\")%")]
    [InlineData("%CALLNAME:PLAYER%(을)를", "%조사처리(CALLNAME:PLAYER,\"을\")%")]
    [InlineData("%CALLNAME:PLAYER%을(를)", "%조사처리(CALLNAME:PLAYER,\"을\")%")]
    [InlineData("%CALLNAME:PLAYER%를(을)", "%조사처리(CALLNAME:PLAYER,\"을\")%")]
    [InlineData("%CALLNAME:PLAYER%(를)을", "%조사처리(CALLNAME:PLAYER,\"을\")%")]
    [InlineData("%CALLNAME:PLAYER%을/를", "%조사처리(CALLNAME:PLAYER,\"을\")%")]
    [InlineData("%CALLNAME:ARG%(은)는", "%조사처리(CALLNAME:ARG,\"는\")%")]
    ...
    [InlineData("%NAME:TARGET%을(를)", "%조사처리(NAME:TARGET,\"을\")%")]
    [InlineData("%조사선택(CALLNAME:MASTER,\"는\")%", "%조사처리(CALLNAME:MASTER,\"는\")%")]
    ...
    [InlineData("%~%은(는)", "%조사처리(~,\"는\")%")]
    [InlineData("%~%의", "%~%의")]
    [InlineData("%조사처리(CALLNAME:MASTER,\"의\")%", "%조사처리(CALLNAME:MASTER,\"의\")%")]
    ...
    [InlineData("%CALLNAME:MASTER%는 사과은 좋아한다.", "%조사처리(CALLNAME:MASTER,\"는\")% 사과는 좋아한다.")]
