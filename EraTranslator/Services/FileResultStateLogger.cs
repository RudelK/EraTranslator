...
public sealed class FileResultStateLogger(string? baseDirectory = null)
{
    private static readonly object FileLock = new();
    private static long _sequence;

    public string LogFilePath { get; } = Path.Combine(baseDirectory ?? AppContext.BaseDirectory, "EraTranslator.result-state.log");
